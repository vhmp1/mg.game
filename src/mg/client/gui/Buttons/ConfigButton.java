 ...
 * @author Vitor
 */
public class ConfigButton extends MouseOverArea{
     private static Image imageBtn;
     private final ConfigArea controller;

    static {
        try {
            imageBtn = new Image("/resources/lobby/config_btn.png");
        } catch (SlickException ex) {
            Logger.getLogger(SendButton.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public ConfigButton(GUIContext container, int x, int y, ConfigArea controller) {
